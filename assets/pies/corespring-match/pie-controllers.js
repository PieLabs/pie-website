(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["pie-controller-corespring-match"] = factory();
	else
		root["pie-controller-corespring-match"] = factory();
})(this, function() {
...
exports['corespring-match'] = __webpack_require__(2);
...
function countTrueValues(arr) {
  return __WEBPACK_IMPORTED_MODULE_0_lodash__["reduce"](arr, countWhenTrue, 0);
}
...
function countCorrectAnswers(answer, correctAnswer) {
  return __WEBPACK_IMPORTED_MODULE_0_lodash__["reduce"](answer, function(acc1, answerRow) {
    let correctMatchSet = __WEBPACK_IMPORTED_MODULE_0_lodash__["find"](correctAnswer, function(correctRow) {
      return correctRow.id === answerRow.id;
    }).matchSet;

    let zippedMatchSet = __WEBPACK_IMPORTED_MODULE_0_lodash__["zip"](correctMatchSet, answerRow.matchSet);
    let numIncorrect = __WEBPACK_IMPORTED_MODULE_0_lodash__["reduce"](zippedMatchSet, countIncorrect, 0);

    return acc1 + ((0 === numIncorrect) ?
        __WEBPACK_IMPORTED_MODULE_0_lodash__["reduce"](zippedMatchSet, countWhenTrueAndCorrect, 0) : 0);
  }, 0);
}
...
function model(question, session, env) {
  ...
  function numberOfAnswers(answer) {
    ...
    var sum = __WEBPACK_IMPORTED_MODULE_0_lodash__["reduce"](answer, function(sum, row) {
  ...
  return new Promise((resolve) => {
    ...
    if (env.mode === 'evaluate') {
      ...
      if (session !== undefined) {
        ...
        __WEBPACK_IMPORTED_MODULE_0_lodash__["merge"](response, feedback);
      }

      response.correctnessMatrix = __WEBPACK_IMPORTED_MODULE_1__scoring__["a" /* buildCorrectnessMatrix */](question, session.answers);
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = buildCorrectnessMatrix;
...
function countTrueValues(arr) {
  return __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.reduce(arr, countWhenTrue, 0);
}
...
function makeEmptyAnswerRow(correctRow) {
  var answerRow = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.cloneDeep(correctRow);
  answerRow.matchSet = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.map(answerRow.matchSet, function() {
    return false;
  });
  return answerRow;
}
...
function buildCorrectnessMatrix(question, answer) {
  function validateRow(correctRow) {
    let answerRow = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.find(answer, whereIdIsEqual(correctRow.id));
    if (!answerRow) {
      answerRow = makeEmptyAnswerRow(correctRow);
    }
    let zippedMatchSet = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.zip(correctRow.matchSet, answerRow.matchSet);
