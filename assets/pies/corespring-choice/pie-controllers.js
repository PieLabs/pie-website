(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["pie-controller-corespring-choice"] = factory();
	else
		root["pie-controller-corespring-choice"] = factory();
})(this, function() {
...
exports['corespring-choice'] = __webpack_require__(61);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_assign__ = __webpack_require__(62);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_cloneDeep__ = __webpack_require__(86);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_includes__ = __webpack_require__(137);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash_isEmpty__ = __webpack_require__(148);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_lodash_isEqual__ = __webpack_require__(54);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_lodash_map__ = __webpack_require__(157);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__scoring_js__ = __webpack_require__(181);
...
function isResponseCorrect(question, session) {
  ...
  return __WEBPACK_IMPORTED_MODULE_5_lodash_isEqual___default.a((session.value || []).sort(), correctResponse);
}
...
function outcome(question, session = { value: [] }) {
  ...
  return new Promise((resolve, reject) => {
    ...
    if (!question || !question.choices || __WEBPACK_IMPORTED_MODULE_4_lodash_isEmpty___default.a(question.choices)) {
      reject(new Error('Question is missing required array: choices'));
    } else {
      const allCorrect = isResponseCorrect(question, session);
      resolve({
        score: {
          scaled: __WEBPACK_IMPORTED_MODULE_7__scoring_js__["a" /* score */](question, session)
        }
      });
    }
  });
...
function model(question, session, env) {
  ...
  if (env.mode === 'evaluate') {
    console.log('score', __WEBPACK_IMPORTED_MODULE_7__scoring_js__["a" /* score */](question, session));
  }

  function getLabel(arr, lang, fallbackLang) {
    let label = arr.find(l => l.lang === lang);

    if (label && !__WEBPACK_IMPORTED_MODULE_4_lodash_isEmpty___default.a(label.value)) {
      return label.value;
    } else {
      ...
      return out && !__WEBPACK_IMPORTED_MODULE_4_lodash_isEmpty___default.a(out.value) ? out.value : undefined;
    }
  }
  ...
  return new Promise((resolve, reject) => {
    ...
    if (__WEBPACK_IMPORTED_MODULE_4_lodash_isEmpty___default.a(question)) {
      reject(new Error('Empty model'));
    }

    let responseCorrect = env.mode === 'evaluate' ? isResponseCorrect(question, session) : undefined;
    let out = __WEBPACK_IMPORTED_MODULE_1_lodash_cloneDeep___default.a(question);
...
var Stack = __webpack_require__(26),
    arrayEach = __webpack_require__(110),
...
function allCorrect(question, session) {
  ...
  let correctResponse = getCorrectResponse(question.choices);
  return __WEBPACK_IMPORTED_MODULE_0_lodash_isEqual___default.a((session.value || []).sort(), correctResponse);
}
