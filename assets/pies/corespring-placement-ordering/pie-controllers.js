(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["pie-controller-corespring-placement-ordering"] = factory();
	else
		root["pie-controller-corespring-placement-ordering"] = factory();
})(this, function() {
...
exports['corespring-placement-ordering'] = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__scoring__ = __webpack_require__(5);
...
function outcome(question, session, env) {
  ...
  return new Promise((resolve, reject) => {
    if (!question || !question.correctResponse || __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.isEmpty(question.correctResponse)) {
      reject(new Error('Question is missing required array: correctResponse'));
    } else {
      resolve({
        score: {
          scaled: __WEBPACK_IMPORTED_MODULE_1__scoring__["b" /* score */](question, session)
        }
      });
    }
  });
...
function model(question, session, env) {
  ...
  function getLabel(arr, lang, fallbackLang) {
    ...
    if (label && !__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.isEmpty(label.value)) {
      return label.value;
    } else {
      ...
      return out && !__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.isEmpty(out.value) ? out.value : undefined;
    }
  }
  ...
  function shuffle(session, choices) {
    if (session.stash && session.stash.shuffledOrder) {
      ...
      let result = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.cloneDeep(choices);
      for (var i = choices.length - 1; i >= 0; i--) {
        if (choices[i].shuffle === false) {
          result.splice(i, 1);
        }
      }
      let shuffled = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.shuffle(__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.cloneDeep(result));
  ...
  var base = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.assign({}, __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.cloneDeep(question.model));
  ...
  base.choices = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.map(choices, (c) => {
  ...
  if (env.mode === 'evaluate') {
    base.outcomes = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.map(session.value, function(c, idx) {
      return {
        id: c,
        outcome: __WEBPACK_IMPORTED_MODULE_1__scoring__["a" /* flattenCorrect */](question)[idx] === c ? 'correct' : 'incorrect'
      }
    });
    var allCorrect = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.isEqual(__WEBPACK_IMPORTED_MODULE_1__scoring__["a" /* flattenCorrect */](question), session.value);
    if (!allCorrect) {
      base.correctResponse = __WEBPACK_IMPORTED_MODULE_1__scoring__["a" /* flattenCorrect */](question);
    }
  }
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = flattenCorrect;
...
function defaultScore(question, session) {
  ...
  let allCorrect = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.isEqual(__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.cloneDeep(session.value).sort(), __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.cloneDeep(flattenCorrect(question)).sort());
