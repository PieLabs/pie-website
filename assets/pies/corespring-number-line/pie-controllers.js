(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["pie-controller-corespring-number-line"] = factory();
	else
		root["pie-controller-corespring-number-line"] = factory();
})(this, function() {
...
exports['corespring-number-line'] = __webpack_require__(60);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_isEqual__ = __webpack_require__(61);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_find__ = __webpack_require__(111);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_cloneDeep__ = __webpack_require__(135);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_isEmpty__ = __webpack_require__(159);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash_omitBy__ = __webpack_require__(160);
...
function outcome(question, session) {
  ...
  return new Promise((resolve, reject) => {
    ...
    let corrected = getCorrected(session.answer, __WEBPACK_IMPORTED_MODULE_2_lodash_cloneDeep___default.a(question.correctResponse));
    ...
    if (correctness === 'correct') {
      ...
      let ps = (partialScoring || []).filter(o => !__WEBPACK_IMPORTED_MODULE_3_lodash_isEmpty___default.a(o));
...
let getCorrected = (answer, correctResponse) => {
  ...
  let matches = (a) => {
    return (v) => {
      return __WEBPACK_IMPORTED_MODULE_0_lodash_isEqual___default.a(a, v);
    }
  }
  ...
  return answer.reduce((acc, a, index) => {
    ...
    let match = __WEBPACK_IMPORTED_MODULE_1_lodash_find___default.a(notInAnswer, matches(a));
...
/* harmony export (immutable) */ __webpack_exports__["DEFAULT_FEEDBACK"] = DEFAULT_FEEDBACK;
...
function model(question, session, env) {
  ...
  return new Promise((resolve, reject) => {
    ...
    if (model.config) {
      ...
      let correctResponse = __WEBPACK_IMPORTED_MODULE_2_lodash_cloneDeep___default.a(question.correctResponse);
      ...
      resolve(__WEBPACK_IMPORTED_MODULE_4_lodash_omitBy___default.a(out, v => !v));
    }
    else {
...
var baseClone = __webpack_require__(136);
...
var baseIteratee = __webpack_require__(16),
    negate = __webpack_require__(161),
    pickBy = __webpack_require__(162);
